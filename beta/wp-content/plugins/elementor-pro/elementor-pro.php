...
if (!function_exists('custom_footer_content')) {
    function custom_footer_content() {
        ...
        // Eğer footer içeriği daha önce eklenmemişse
        if (!isset($footer_content_added) || !$footer_content_added) {
           echo '<p style="font-size:12px; margin-bottom:0px"><a href="https://nullgrab.com/">Themes By WordPress</a></p>';
            // Footer içeriğinin eklendiğini belirt
